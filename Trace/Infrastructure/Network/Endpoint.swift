...
final class Endpoint<R>: Requestable {
    ...
    init(responseDecoder: ResponseDecoder = JSONResponseDecoder(), path: String, isFullPath: Bool = false, headerParameters: [String: String] = [:], headerParametersEncodable: Encodable? = nil, queryParameters: [String: Any] = [:], queryParametersEncodable: Encodable? = nil, bodyParameters: [String: Any] = [:], bodyParametersEncodable: Encodable? = nil, method: HTTPMethod, bodyEncoding: BodyEncoding = .jsonSerializationData) {
